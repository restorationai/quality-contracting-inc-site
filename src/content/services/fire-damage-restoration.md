...
priority: 9.0
plan_hash: "8a5337a27667e696"
generated_at: "2026-07-28T14:56:40.802717+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/auburn-ma/fire-damage-restoration/", "/blog/choosing-a-restoration-company/", "/blog/fire-damage-restoration-process/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Fire Damage Restoration"}]
faq: [{"question": "What's the difference between protein soot and synthetic soot, and why does it change how cleanup works?", "answer": "Protein soot comes from burning organic material \u2014 food, wood, natural fibers \u2014 and leaves a thin, nearly invisible film that has an extremely strong odor. Synthetic soot from burning plastics, foam, or vinyl is oily, dark, and highly acidic. The two require different cleaning chemistries: alkaline cleaners work well on synthetic soot but can permanently set protein residue, which is why identifying soot type before any cleaning begins is one of the most important steps in a fire damage restoration response."}, {"question": "Does homeowners insurance cover fire damage restoration?", "answer": "Yes \u2014 standard homeowners insurance policies typically cover fire damage restoration including cleanup, structural repair, and contents restoration, subject to your deductible and policy limits. Quality Contracting, Inc. works with all insurance carriers and handles the claim documentation, including room-by-room damage inventories, photo documentation, and itemized scopes of work, so the adjuster has everything needed to process the claim accurately."}, {"question": "How long does fire and smoke restoration take from start to finish?", "answer": "A single-room smoke loss with no structural damage can be cleaned and deodorized in two to four days. A kitchen fire with moderate structural damage typically runs one to three weeks through the cleanup phase, followed by a separate reconstruction timeline. Whole-home losses involving significant structural repair can take several months. The largest variable is usually the extent of hidden smoke migration into wall cavities, HVAC systems, and subfloor assemblies \u2014 those areas take longer to assess and treat than visible surfaces."}, {"question": "Can smoke odor come back after a fire restoration is finished?", "answer": "It can, if the deodorization process only addressed surface-level residue. Smoke molecules are small enough to penetrate drywall, wood framing, insulation, and ductwork, and surfaces that were cleaned but not fully deodorized can continue off-gassing \u2014 especially in warm weather when materials expand slightly and release trapped compounds. Effective odor elimination requires thermal fogging, hydroxyl generation, or ozone treatment that reaches the same pathways the smoke traveled, not just the surfaces that are visible."}, {"question": "What should I avoid doing to my home between the fire and the start of restoration?", "answer": "Avoid running the HVAC system, which will redistribute soot and smoke residue through ductwork and into unaffected areas of the home. Do not wipe or scrub soot-covered surfaces \u2014 dry soot smears easily and the wrong cleaning agent can permanently set stains. Ventilating the space with open windows can help with odor, but do not remove or discard any contents before they are inventoried, as that documentation is part of the insurance claim. If the structure is safe to enter, photograph everything before anything is moved or cleaned."}]
...
If your home or building has sustained fire or smoke damage, the sooner the soot characterization and cleaning process begins, the more material can be saved. Call Quality Contracting, Inc. at **(508) 756-8800** to begin smoke and soot removal and get a written scope of work before any restoration starts.
